...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT_LAYER] = LAYOUT_65_ansi_blocker(
    ...
    [_NON_FUNC_LAYER] = LAYOUT_65_ansi_blocker(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          KC_GRV,
        KC_TAB,      KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,      KC_DEL,
        KC_RALT,       KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,              KC_PGUP,
        KC_LSFT,            KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,          KC_PGDN,
    ...
    [_FUNC_LAYER] = LAYOUT_65_ansi_blocker(
    ...
    [_SETTINGS_LAYER] = LAYOUT_65_ansi_blocker(
        XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  XXXXXXX,          BASE_LAYER_CHANGE,
        XXXXXXX,     RGB_TOG, XXXXXXX,  RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_MPLY, KC_MPRV, KC_MNXT, XXXXXXX,     XXXXXXX,
        XXXXXXX,        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,            KC_HOME,
        XXXXXXX,           RESET,  RGB_SPI,  RGB_SPD, XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,      KC_END,
...
#   if defined(RGB_MATRIX_ENABLE) && \
       defined(RGB_MATRIX_KEYPRESSES) && \
       defined(RGB_MATRIX_FRAMEBUFFER_EFFECTS)
    ...
    if ((current_effect >= RGB_MATRIX_SOLID_REACTIVE_SIMPLE &&
        current_effect <= RGB_MATRIX_SOLID_REACTIVE_MULTINEXUS) ||
        current_effect == RGB_MATRIX_TYPING_HEATMAP) {
